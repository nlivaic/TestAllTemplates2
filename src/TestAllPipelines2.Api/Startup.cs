...
using TestAllPipelines2.Api.Helpers;
using TestAllPipelines2.Api.Middlewares;
using TestAllPipelines2.Application;
...
namespace TestAllPipelines2.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                var connString = new SqlConnectionStringBuilder(_configuration.GetConnectionString("TestAllPipelines2DbConnection") ?? string.Empty)
                {
            ...
            services.AddSwaggerGen(setupAction =>
            {
                setupAction.SwaggerDoc(
                    "TestAllPipelines2OpenAPISpecification",
                    new OpenApiInfo
                    {
                        Title = "TestAllPipelines2 API",
                        Version = "v1",
                        Description = "This API allows access to TestAllPipelines2.",
                ...
                setupAction.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "TestAllPipelines2.Api.xml"));
            });
            ...
            services.AddCors(o => o.AddPolicy("TestAllPipelines2Client", builder =>
            {
            ...
            services.AddTestAllPipelines2ApplicationHandlers();
            ...
            services
                .AddHealthChecks()
                .AddDbContextCheck<TestAllPipelines2DbContext>();
        }
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            //    app.UseHsts();
            // }
            app.UseCors("TestAllPipelines2Client");
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/TestAllPipelines2OpenAPISpecification/swagger.json", "TestAllPipelines2 API");
